...
#define glTexParameteri glTexParameterf
	...
	WINGDIAPI void APIENTRY glColor3ub(GLubyte r, GLubyte g, GLubyte b);
	...
	WINGDIAPI void APIENTRY glNormal3f(GLfloat x, GLfloat y, GLfloat z);

	WINGDIAPI void APIENTRY glActiveTexture(GLenum texture);
	WINGDIAPI void APIENTRY glClientActiveTexture(GLenum texture);
	WINGDIAPI void APIENTRY glMultiTexCoord2f(GLenum texture, GLfloat s, GLfloat t);
