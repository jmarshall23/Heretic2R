...
{
	skel->rootJoint = (M_SkeletalJoint_t*) Hunk_Alloc(numJointsInSkeleton[structure] * (int)sizeof(M_SkeletalJoint_t));
	skel->rootNode = (ArrayedListNode_s *) Hunk_Alloc(numNodesInSkeleton[structure] * (int)sizeof(ArrayedListNode_t));
